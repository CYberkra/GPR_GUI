...
matplotlib.rcParams['font.sans-serif'] = ['Noto Sans CJK SC', 'Microsoft YaHei', 'SimHei', 'Arial Unicode MS', 'DejaVu Sans']
...
METHOD_DISPLAY_NAMES = {
    ...
    # 备选/扩展
    "agcGain": "7. 增益（AGC，备选）",
    "svd_bg": "8. 背景去除（SVD，备选）",
    "rpca_placeholder": "9. 背景去除（RPCA，占位）",
    "wnnm_placeholder": "10. 背景去除（WNNM，占位）",
    # 重复性方法（置底）
    "sliding_avg": "11. 滑动平均背景去除（与步骤3重复）",
    "running_average_2D": "12. 运行平均抑噪（与步骤6重复）",
    "compensatingGain": "13. 增益补偿（与步骤5/7重复）",
}
...
class GPRGuiQt(QMainWindow):
    def __init__(self):
        ...
        self.btn_batch = QPushButton("批处理功能维护中")
        self.btn_batch.setEnabled(False)
        self.btn_batch.setToolTip("已临时关闭：该功能存在稳定性问题，待修复后恢复")
